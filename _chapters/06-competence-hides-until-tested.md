...
When competence is assumed rather than tested, organisations place trust incorrectly. Responsibility accumulates around those who look capable in calm conditions. When pressure eventually arrives, gaps are exposed at the worst possible moment — when the cost of failure is highest and the ability to recover is limited.
