...
This chapter is about how a problem travels across boundaries and surfaces unowned; that no single person holds the whole system in view is the related but separate failure of no one owning the whole.
